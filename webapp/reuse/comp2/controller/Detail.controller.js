sap.ui.define(["sap/ui/core/mvc/Controller", "sap/base/Log"], function(
	...
	"use strict"
	return Controller.extend("yelcho.reuse.comp2.controller.Detail", {
		onInit: function() {
		...
		_onPatternMatched: function(oEvent) {
			Log.info("yelcho.reuse.comp2.controller.Detail", "_onPatternMatched")
		},
		_onBypassed: function(oEvent) {
			Log.info(
				"yelcho.reuse.comp2.controller.Detail",
